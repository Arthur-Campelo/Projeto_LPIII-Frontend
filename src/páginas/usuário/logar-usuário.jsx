...
import {
    TAMANHOS, estilizarBotão, estilizarCard, estilizarDivCampo, estilizarFlex,
    estilizarInputMask, estilizarLabel, estilizarLink, estilizarLogo, estilizarPasswordInput,
    estilizarPasswordTextInputBorder, estilizarPáginaÚnica
    ...
    async function logarUsuário() {
        if (validarCampos()) {
            try {
                ...
                setUsuárioLogado({
                    ...response.data?.usuárioLogado, cnpj: dados.nome_login,
                    cadastrado: true
                });
